...
1. **海量数据迁移方案**
1. **Massive Data Migration Solution**
...
3. **多线程批量数据处理**
3. **Multi-thread Batch Data Processing**
...
4. **船舶行业领域建模**
4. **Shipping Industry Domain Modeling**
...
1. Modify MySQL address, username and password in `application.yml`
2. Maven刷新依赖，运行 `DigitalManagementApplication` 启动类
2. Refresh Maven dependencies and run main class `DigitalManagementApplication`
